...
export default function App() {
  ...
  return (
    <div
      style={{
        minHeight: "100vh",
        background: "linear-gradient(120deg, #f6f7fb 0%, #f0f2f5 100%)",
        padding: 0,
        margin: 0,
    ...
    >
      ...
      >
        ...
        >
          Summarize &amp; ask questions on your PDFs
        </div>
      </header>
      <main
        style={{
            ...
            <div style={{ marginTop: 32 }}>
              ...
              <button
                ...
                style={{
                  ...
                  boxShadow:
                    selectedPdf && !loading
                      ? "0 8px 32px #3b82f633, 0 1.5px 8px #fff8"
                      : "none",
                  cursor: selectedPdf && !loading ? "pointer" : "not-allowed",
                  transition:
                    "background 0.18s, color 0.18s, box-shadow 0.18s, transform 0.14s, border 0.18s",
                  marginTop: 22,
                  width: "100%",
                  outline: "none",
                  borderBottom:
                  ...
                  overflow: "hidden",
                  backdropFilter:
                    selectedPdf && !loading ? "blur(2.5px)" : "none",
      ...
      >
        &copy; {new Date().getFullYear()} PDF Summary App &mdash; Built with
        FastAPI &amp; React
      </footer>
      {/* Spinner CSS */}
      <style>{`
